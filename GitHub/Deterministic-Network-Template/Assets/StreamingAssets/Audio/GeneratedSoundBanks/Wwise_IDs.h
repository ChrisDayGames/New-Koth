...
namespace AK
{
    namespace EVENTS
    {
        static const AkUniqueID BIRTHDAY_HATTHROW = 871002828U;
        static const AkUniqueID BIRTHDAYDEATH = 716984660U;
        static const AkUniqueID BIRTHDAYJUMP = 1992502354U;
        static const AkUniqueID BIRTHDAYWIN = 3067127960U;
        static const AkUniqueID DASH = 1942692385U;
        static const AkUniqueID EXTINGUISH = 534702089U;
